<?php 
  ...
  $query = "SELECT * FROM produk WHERE kategori = 'tart'";
...
<body>
  ...
  <div class="container">
    ...
    <div class="tabs">
      ...
      <a href="tart.php" class="tab active-tab">TART</a>
    ...
    <div class="products">
      <?php foreach ($produk as $item): ?>
        <div class="product-card" 
          ...
          <img src="../image/tart/<?= $item['url_gambar'] ?>" alt="<?= htmlspecialchars($item['nama_produk']) ?>">
  ...
  <script>
    ...
    productCards.forEach(card => {
      card.addEventListener("click", () => {
        ...
        // FIX path gambar
        modalImg.src = "../image/tart/" + card.getAttribute("data-img");
