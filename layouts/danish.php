<?php 
  ...
  $query = "SELECT * FROM produk WHERE kategori = 'danish'";
...
<body>
  ...
  <div class="container">
    ...
    <div class="tabs">
      ...
      <a href="danish.php" class="tab active-tab">DANISH</a>
    ...
    <div class="products">
      <?php foreach ($produk as $item): ?>
        <div class="product-card" 
          ...
          <img src="../image/danish/<?= $item['url_gambar'] ?>" alt="<?= htmlspecialchars($item['nama_produk']) ?>">
  ...
  <script>
    ...
    productCards.forEach(card => {
      card.addEventListener("click", () => {
        ...
        // FIX path gambar
        modalImg.src = "../image/danish/" + card.getAttribute("data-img");
