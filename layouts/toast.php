<?php 
  ...
  $query = "SELECT * FROM produk WHERE kategori = 'toast'";
...
<body>
  ...
  <div class="container">
    ...
    <div class="tabs">
      ...
      <a href="toast.php" class="tab active-tab">TOAST</a>
    ...
    <div class="products">
      <?php foreach ($produk as $item): ?>
        <div class="product-card" 
          ...
          <img src="../image/toast/<?= $item['url_gambar'] ?>" alt="<?= htmlspecialchars($item['nama_produk']) ?>">
  ...
  <script>
    ...
    productCards.forEach(card => {
      card.addEventListener("click", () => {
        ...
        // FIX path gambar
        modalImg.src = "../image/toast/" + card.getAttribute("data-img");
