<?php 
  ...
  $query = "SELECT * FROM produk WHERE kategori = 'mini cake'";
...
<body>
  ...
  <div class="container">
    ...
    <!-- kategori -->
    <div class="tabs">
      <a href="minicake.php" class="tab active-tab">MINI CAKE</a>
    ...
    <div class="products">
      <?php foreach ($produk as $item): ?>
        <div class="product-card" 
          ...
          <img src="../image/minicake/<?= $item['url_gambar'] ?>" alt="<?= htmlspecialchars($item['nama_produk']) ?>">
  ...
  <script>
    ...
    productCards.forEach(card => {
      card.addEventListener("click", () => {
        ...
        // FIX path gambar
        modalImg.src = "../image/minicake/" + card.getAttribute("data-img");
