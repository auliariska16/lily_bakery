<?php 
  ...
  // Ambil semua produk dengan kategori 'toast'
  $query = "SELECT * FROM produk WHERE kategori = 'pudding'";
...
<body>
    ...
    <div class="products">
      <?php foreach ($produk as $item): ?>
        <div class="product-card" 
          ...
          <img src="../image/pudding/<?= $item['url_gambar'] ?>" alt="<?= htmlspecialchars($item['nama_produk']) ?>">
  ...
  <script>
    ...
    productCards.forEach(card => {
      card.addEventListener("click", () => {
        ...
        // FIX path gambar
        modalImg.src = "../image/pudding/" + card.getAttribute("data-img");
  ...
  <footer class="footer">
    <div class="footer-column">
      ...
      <p>LILY is a new Japanese-inspired bakery and pastry<br />shop serving amazing handmade breads, cakes and<br />puddings.</p>
